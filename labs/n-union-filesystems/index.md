...
```bash
sudo mount -t overlay overlay -o lowerdir=./layer1,upperdir=./layer2,work=./work ./merged
```
...
```bash
mkdir ./layer0
sudo mount -t overlay overlay -o lowerdir=./layer1:./layer0,upperdir=./layer2,work=./work ./merged
```
...
```bash
sudo mount -t overlay overlay -o lowerdir=./layer0:./layer1,upperdir=./layer2,work=./work ./merged
```
